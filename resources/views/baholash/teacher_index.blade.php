                ...
                <tbody>
                    @forelse($sinflar as $i => $sinf)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('baholar.teacher.students', $sinf->id) }}"
                                   class="btn btn-sm btn-outline-primary" title="O'quvchilarni ko'rish">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('baholar.mark', $sinf->id) }}"
                                   class="btn btn-sm btn-outline-warning" title="Baho qo'yish">
